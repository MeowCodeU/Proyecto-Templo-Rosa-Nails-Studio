document.addEventListener("DOMContentLoaded", function () {
    ...
    function llenarFormularioEditar(evento) {
        ...
        const selectServicios = document.getElementById(
            "editarServiciosAgendamiento"
        );
        ...
        if (selectCliente) {
            selectCliente.disabled = esBloqueo;
            selectCliente.required = !esBloqueo;
        }

        if (selectServicios) {
            selectServicios.disabled = esBloqueo;
            selectServicios.required = !esBloqueo;
        }

        if (inputDuracion) {
            inputDuracion.readOnly = !esBloqueo;
        }
    }
